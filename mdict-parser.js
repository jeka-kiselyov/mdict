  ...
  function parse_mdict(file, ext) {
    ...
    function Scanner(buf, len) {
      ...
      var methods = {
        ...
        readUTF16:  function(len) { return conseq(UTF_16LE.decode(newUint8Array(buf, offset, len)), this.forward(len)); },
...
// console.log('trail: ', _trail);          
    ...
    return _slice(pos, 4).exec(read_file_head).then(function(len) {
      len = parseInt(len, 10);
      ...
      var keyword_summary = data[0]; 
      var keyword_index = data[1];      // console.log(data[1]); // console.log(data);
